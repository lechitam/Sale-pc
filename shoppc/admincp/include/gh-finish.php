<?php
	$query=mysql_query("select sanpham.*,giohang.* from giohang,sanpham where giohang.id=sanpham.id");
...
<table width="735" border="0" cellspacing="0" cellpadding="0">
  ...
  <?php
		$kq2=mysql_query("select count(*) from giohang where tinhtrang='damua'"); 
